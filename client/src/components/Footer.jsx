...
const Footer = () => {
  return (
    <footer className="bg-[#0F172A] py-16 border-t border-[#1E293B]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center">
        
        {/* Logo & Tagline */}
        <div className="mb-8 text-center">
          <span className="font-bold text-3xl tracking-tight font-sans text-[#F8FAFC]">glide</span>
          <p className="text-[#64748B] mt-2 text-sm uppercase tracking-wider font-semibold">
        ...
        <div className="text-center space-y-4">
           <p className="text-[#475569] text-xs pt-4">
             &copy; 2026 glide
           </p>
        </div>
      </div>
